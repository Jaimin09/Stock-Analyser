...
def inputurl():
    if request.method=="POST":
        ...
        try :
            ...
            return render_template("print.html",score = score, rating = rating, info = info,
                               ls_price = ls_price, curr_price = curr_price, gain = gain)

        except UnboundLocalError:
            return render_template("value_error.html", msg = "Our algorithm couldn't get the analyse this stock. Make sure the company-stock is not of any kind of bank's, as banks are currently not supported.")
